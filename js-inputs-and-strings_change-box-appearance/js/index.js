...
inputColorSlider = document.querySelector("[data-js=input-color]");
...
inputColorSlider.addEventListener("input", () => {
  box.style.background = "hsl(" + inputColorSlider.value + " 100% 50% / 50%)";
});

radiusSlider.addEventListener("input", () => {
  box.style.borderRadius = radiusSlider.value * 2 + "px";
});

rotationSlider.addEventListener("input", () => {
  box.style.transform = "rotateZ(" + rotationSlider.value + "deg)";
});
